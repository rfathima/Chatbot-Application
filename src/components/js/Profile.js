...
const Profile = () => {
  return (
    <div className='p-4'>
      ...
      <div className="overflow-hidden profile rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark">
        <div className="relative z-20 h-35 md:h-65">
          ...
          <div className="absolute bottom-1 right-1 z-10 xsm:bottom-4 xsm:right-4">
            ...
            >
              ...
              <div className='flex bg-red-600 p-2 rounded-lg items-center'>
                <span className='mr-2'>
                    <svg
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          <div className="relative z-30 mx-auto mt-[-80px] h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
            <div className="relative flex justify-center">
              <img src={user} className="w-[160px] h-[150px] p-[8px] rounded-full" alt="profile" />
              <label
                htmlFor="profile"
          ...
          <div className="flex flex-col gap-4">
            <h3 className="mb-1.5 text-2xl font-semibold text-black dark:text-white text-color">
              Razul Fathima
            </h3>
            <p className="font-medium">Frontend Developer</p>
            <div className="mx-auto grid max-w-94 grid-cols-3 rounded-md border border-stroke py-2.5 shadow-1 dark:border-strokedark dark:bg-[#37404F]">
              <div className="flex items-center justify-center gap-1 border-r border-stroke px-4 dark:border-strokedark xsm:flex-row">
                <span className="font-bold text-black dark:text-white text-color">
                  259
                </span>
              ...
              <div className="flex items-center justify-center gap-1 px-4 xsm:flex-row">
                <span className="font-bold text-black dark:text-white text-color">
                  2K
                </span>
            ...
            <div className="mx-auto max-w-180">
              <h4 className="font-bold text-black dark:text-white text-lg text-color">
                About Me
              </h4>
              <p className="mt-4.5">
            ...
            <div className="mt-6.5">
              <h4 className="mb-3.5 font-medium text-black dark:text-white text-color">
                Follow me on
              </h4>
